    ...
    <div className="animate-in fade-in duration-700">
      ...
      <section className="relative h-[80vh] w-full bg-gray-50 flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://images.unsplash.com/photo-1573408301185-9146fe634ad0?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" 
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="flex justify-between items-end mb-12">
          ...
          <Link to="/shop" className="text-sm underline hover:text-gray-600">View All</Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {featuredProducts.map((product) => (
            <Link key={product.id} to={`/product/${product.id}`} className="group">
              ...
              <h3 className="text-lg font-serif mb-1 group-hover:underline decoration-1 underline-offset-4">{product.name}</h3>
      ...
      <section className="py-24 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <Link to="/about" className="text-white border-b border-white pb-1 hover:text-gray-300 hover:border-gray-300 transition-colors">
              Read Our Story
            </Link>
          </div>
        </div>
